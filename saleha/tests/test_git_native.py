...
class VerificationClaimTests(unittest.TestCase):
    ...
    def test_default_does_not_claim_tests_passed(self):
...
class StagingSafetyTests(unittest.TestCase):
    ...
    def test_missing_file_list_is_refused_not_staged_wholesale(self):
    ...
    def test_named_files_do_not_drag_in_unrelated_changes(self):
        self._write("agent.py", "x = 1\n")
    ...
    def test_stage_all_still_available_when_explicitly_requested(self):
    ...
    def test_committed_message_reflects_the_real_verification_state(self):
        self._write("a.py", "x = 1\n")
    ...
    def test_commit_deliverable_forwards_test_passed(self):
...
class HardResetGateTests(StagingSafetyTests):
    ...
    def test_hard_reset_is_gated_and_preserves_uncommitted_work(self):
    ...
    def test_soft_rollback_is_not_gated(self):
        self._write("a.py", "x = 1\n")
...
class CallerStagingTests(unittest.TestCase):
    ...
    def test_refactorer_passes_the_files_it_rewrote(self):
        import inspect
