...
class _StreamProvider:
    ...
    def __init__(self, tokens: Any=("hel", "lo ", "world")) -> None:
        self.tokens = tokens
        self.calls = []

    def stream_generate(self, model: Any, prompt: Any, callback: Optional[Any]=None, options: Optional[Any]=None) -> Any:
...
class ThinkStreamTests(unittest.TestCase):
    ...
    def test_fallback_when_provider_has_no_stream(self) -> None:
    ...
    def test_router_stats_recorded_on_stream_path(self) -> None:
    ...
    def test_reflexion_appended_in_stream_prompt(self) -> Any:
        provider = _StreamProvider()
        captured = {}

        def spy_stream(model: Any, prompt: Any, callback: Optional[Any]=None, options: Optional[Any]=None) -> Any:
